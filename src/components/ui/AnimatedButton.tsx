...
export function AnimatedButton({
  ...
  const base =
    "relative inline-flex touch-manipulation items-center justify-center gap-2 overflow-hidden rounded-full px-8 py-3.5 text-sm font-medium tracking-wide transition-colors duration-200 lg:px-10 lg:py-4 lg:text-base";
  const variants = {
    primary:
