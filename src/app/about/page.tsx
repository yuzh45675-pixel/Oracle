...
const sections = [
  {
    title: "塔罗与雷诺曼",
    body: "本站提供两套牌，用途相近、读法不同。韦特塔罗共 78 张，分大阿卡纳与小阿卡纳，强调象征、意象与正逆位；适合追问「为什么」「内在状态如何变化」。雷诺曼共 36 张，牌义更直白，常通过相邻牌组合成句，一般不读逆位；适合具体情境、时间线与事实层面的问题。你可以按问题性质选牌组，也可以两套都体验。",
  },
  {
    title: "使用说明",
    body: "从首页选择牌组与牌阵，写下问题（可选）后进入占卜。流程为：洗牌 → 切牌或滑动点选 → 按位置逐张翻开牌面 → 查看牌阵与解读。导航中的「呼吸」是独立静心练习，不进入抽牌流程；「历史」可查看本机保存的记录。牌面全部揭示后，可登录请 AI 像咨询师一样解读，并支持追问。",
  },
  {
    title: "呼吸",
